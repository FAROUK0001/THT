...
\renewcommand{\cftsubsecfont}{\small\color{textmed}}
...
\begin{tikzpicture}[scale=0.85]
  ...
  \node[draw=hvgreen, fill=hvgreen!15, rounded corners, minimum width=2.2cm, minimum height=1cm]
    (gen) at (0,0) {\small\textbf{Génération}\\[-2pt]\tiny 10--20\,kV};
  \node[draw=midblue, fill=midblue!15, rounded corners, minimum width=2.2cm, minimum height=1cm]
    (step1) at (3.5,0) {\small\textbf{Élévation}\\[-2pt]\tiny 400\,kV};
  \node[draw=darkblue, fill=darkblue!15, rounded corners, minimum width=2.6cm, minimum height=1cm, text=white]
    (trans) at (7.5,0) {\small\textbf{Transport THT}\\[-2pt]\tiny 225--765\,kV};
  \node[draw=accent, fill=accent!15, rounded corners, minimum width=2.2cm, minimum height=1cm]
    (step2) at (11.5,0) {\small\textbf{Abaissement}\\[-2pt]\tiny 63\,kV};
  \node[draw=hvred, fill=hvred!10, rounded corners, minimum width=2.2cm, minimum height=1cm]
    (dist) at (15,0) {\small\textbf{Distribution}\\[-2pt]\tiny 20\,kV/400\,V};

  \draw[-Stealth, thick, midblue] (gen) -- (step1) node[midway, above, small] {};
...
\begin{tikzpicture}[scale=0.9,
  ...
  % Stage 1
  \node[component] (T1) at (0,0) {\textbf{T$_1$}\\[2pt]\footnotesize $V_1 = 100\,\si{kV}$};
  % Stage 2
  \node[component] (T2) at (3.5,1.5) {\textbf{T$_2$}\\[2pt]\footnotesize $V_2 = 100\,\si{kV}$};
  % Stage 3
  \node[component] (T3) at (7,3.0) {\textbf{T$_3$}\\[2pt]\footnotesize $V_3 = 100\,\si{kV}$};
  % Connections
